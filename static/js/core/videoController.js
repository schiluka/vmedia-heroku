function videoController($scope,$rootScope, $http){
	...
	var searchVideosAPI = 'js/common/searchVideos-output_JSON.js'; // ----- 
	...
	function showVideos(responseData){  
		$scope.videoData  = responseData.videos;
	...
	$scope.searchVideo = function(){
		...
		if(sCount === $scope.selectVJSON.length){
			...
			callServerGETAPI(httpPromise, searchVideosAPI, showVideos, forminputData); 
		}
